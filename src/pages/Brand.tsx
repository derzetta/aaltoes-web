...
const ShowCode = ({ code }: { code: string }) => {
  ...
  return (
    <div className="mt-4">
      ...
      {isVisible && (
        <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-4">
          <pre className="text-left text-sm text-neutral-100/70 overflow-x-auto">
            <code>{code}</code>
          </pre>
        </div>
      )}
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                    <p className="font-sans text-2xl text-neutral-100/90 mb-2">Geist</p>
                    <p className="text-neutral-100/70">Primary Sans Font</p>
                    <p className="text-neutral-100/90 mt-4">The quick brown fox jumps over the lazy dog.</p>
                  </div>
                  <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                    <p className="font-mono text-2xl text-neutral-100/90 mb-2">Geist Mono</p>
                    <p className="text-neutral-100/70">Monospace Font</p>
                    <p className="font-mono text-neutral-100/90 mt-4">The quick brown fox jumps over the lazy dog.</p>
                  </div>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                  ...
                  <p className="font-mono text-neutral-100/50 text-sm tracking-widest uppercase">Monospace Text - 14px</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-4">
                  <div className="h-20 bg-neutral-950 rounded mb-2"></div>
                  <p className="font-mono text-sm text-neutral-100/70">Background</p>
                  <p className="font-mono text-xs text-neutral-100/50">neutral-950</p>
                </div>
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-4">
                  <div className="h-20 bg-neutral-100 rounded mb-2"></div>
                  <p className="font-mono text-sm text-neutral-100/70">Text Primary</p>
                  <p className="font-mono text-xs text-neutral-100/50">neutral-100</p>
                </div>
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-4">
                  <div className="h-20 bg-neutral-100/10 rounded mb-2"></div>
                  <p className="font-mono text-sm text-neutral-100/70">Border Light</p>
                  <p className="font-mono text-xs text-neutral-100/50">neutral-100/10</p>
                </div>
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-4">
                  <div className="h-20 bg-neutral-900 rounded mb-2"></div>
                  <p className="font-mono text-sm text-neutral-100/70">Surface</p>
                  <p className="font-mono text-xs text-neutral-100/50">neutral-900</p>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[90, 80, 70, 50].map((opacity) => (
                  <div key={opacity} className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-4">
                    <p className={`text-neutral-100/${opacity} mb-2`}>{opacity}% Opacity</p>
                    <p className="font-mono text-xs text-neutral-100/50">neutral-100/{opacity}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                  ...
                  <p className="text-neutral-100/70">Basic card with backdrop blur effect and border.</p>
                </div>
                <div className="bg-neutral-950/50 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                  <h4 className="text-lg font-medium mb-2">Darker Variant</h4>
                  <p className="text-neutral-100/70">Card with higher background opacity.</p>
                </div>
              </div>
              <ShowCode code={`<div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
  <h4 className="text-lg font-medium mb-2">Card Title</h4>
  <p className="text-neutral-100/70">Card content</p>
</div>`} />
            </div>
            <div>
              <h3 className="subsection-title mb-4">Interactive Card</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="group relative bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6 transition-all hover:bg-neutral-900/50 hover:border-neutral-100/20 cursor-pointer">
                  <h4 className="text-lg font-medium mb-2">Base Card</h4>
                  <p className="text-neutral-100/70">Card with hover state and transition.</p>
                </div>
                <div className="group relative bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6 transition-all hover:bg-neutral-900/50 hover:border-neutral-100/20 cursor-pointer">
                  <h4 className="text-lg font-medium mb-2">With Hover Effect</h4>
                  <p className="text-neutral-100/70">Card with gradient hover effect.</p>
                  <div className="absolute inset-0 -m-[1px] rounded-lg bg-gradient-to-r from-white/0 via-white/10 to-white/0 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                </div>
              </div>
  ...
  <div className="absolute inset-0 -m-[1px] rounded-lg bg-gradient-to-r from-white/0 via-white/10 to-white/0 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                  <div className="w-10 h-10 bg-neutral-100/10 rounded-lg flex items-center justify-center mb-4">
                    <svg className="w-6 h-6 text-neutral-100/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                    </svg>
                  </div>
                  <h4 className="text-lg font-medium mb-2">Resilient Growth</h4>
                  <p className="text-neutral-100/70 text-sm">We push, we rethink, and rework to get further from where we were yesterday, learning from the lessons of the past.</p>
                </div>
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                  <div className="w-10 h-10 bg-neutral-100/10 rounded-lg flex items-center justify-center mb-4">
                    <svg className="w-6 h-6 text-neutral-100/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="text-neutral-100/70 text-sm">We know that triumph comes from rallying bold, diverse squads of unstoppable innovators who tear down every barrier.</p>
                </div>
                <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                  <div className="w-10 h-10 bg-neutral-100/10 rounded-lg flex items-center justify-center mb-4">
                    <svg className="w-6 h-6 text-neutral-100/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="text-neutral-100/70 text-sm">Ideas are great, but execution is everything. We will empower builders, by providing access to historical knowledge and all resources needed.</p>
                </div>
              </div>
...
<div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
  ...
  <p className="text-neutral-100/70 text-sm">Feature description text...</p>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
  <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
    ...
    <h4 className="text-lg font-medium mb-2">Resilient Growth</h4>
    <p className="text-neutral-100/70 text-sm">
                ...
                <div className="flex flex-col items-center gap-4">
                  <div className="w-full max-w-md">
                    <input
                      ...
                      className="w-full bg-neutral-950/50 border border-neutral-100/10 rounded-lg px-4 py-2 text-neutral-100/90 placeholder-neutral-100/30 focus:outline-none focus:border-neutral-100/20"
                    />
                  </div>
                  ...
                  <p className="text-neutral-100/70 text-sm">Scan or download the QR code</p>
                </div>
...
<div>
              ...
              <div className="bg-neutral-950/30 backdrop-blur-sm border border-neutral-100/10 rounded-lg p-6">
                <div className="flex flex-col gap-4">
                  <div className="flex justify-start">
                    <div className="bg-neutral-100/5 rounded-lg p-3 max-w-[80%]">
                      <span className="font-mono text-sm text-neutral-100/50 uppercase tracking-wider mb-2 block">User</span>
                      <p className="text-neutral-100/70">How can I help you today?</p>
                    </div>
                  </div>
                  <div className="flex justify-end">
                    <div className="bg-neutral-100/10 rounded-lg p-3 max-w-[80%]">
                      <p className="text-neutral-100/90 animate-typing overflow-hidden whitespace-nowrap border-r-2 border-neutral-100/50">
  ...
  <div className="bg-neutral-100/5 rounded-lg p-3 max-w-[80%]">
    <span className="font-mono text-sm text-neutral-100/50 uppercase tracking-wider mb-2 block">User</span>
    <p className="text-neutral-100/70">Message text</p>
  </div>
</div>`} />
              </div>
            </div>
        ...
        return (
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="h-2 w-full bg-neutral-100/10 overflow-hidden rounded">
                  <div className="h-full w-full bg-neutral-100/50 animate-loading-bar"></div>
                </div>
                <ShowCode code={`<div className="h-2 w-full bg-neutral-100/10 overflow-hidden rounded">
  <div className="h-full w-full bg-neutral-100/50 animate-loading-bar"></div>
</div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="h-40 relative rounded-lg overflow-hidden">
                <div className="absolute inset-0 bg-neutral-950 bg-grid-neutral-100/30 bg-grid" />
                <div className="absolute inset-0 bg-gradient-to-b from-neutral-950/0 via-neutral-950/50 to-neutral-950" />
                <div className="relative h-full flex items-center justify-center">
                  <p className="text-neutral-100/90">Basic Grid Pattern</p>
                </div>
              </div>
            </div>
            <div>
              <h3 className="subsection-title mb-4">3D Grid with Cone</h3>
              <div className="h-40 relative rounded-lg overflow-hidden bg-neutral-950">
                <div 
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-neutral-950/0 via-neutral-950/50 to-neutral-950" />
                <div className="absolute inset-0 bg-gradient-to-t from-neutral-950 to-transparent" style={{ clipPath: 'polygon(50% 0, 100% 100%, 0 100%)' }} />
                <div className="relative h-full flex items-center justify-center">
                  <p className="text-neutral-100/90">3D Perspective Grid with Cone</p>
                </div>
              </div>
              ...
              <div className="h-60 relative rounded-lg overflow-hidden">
                ...
                <div className="relative h-full flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-neutral-100/70">Content visible through the gradient</p>
                  </div>
                </div>
              </div>
              <ShowCode code={`<div className="relative">
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-neutral-950/0 via-neutral-950/80 to-neutral-950" />
            ...
            <div>
              ...
              <div className="h-60 relative rounded-lg overflow-hidden">
                ...
                <div className="absolute inset-0 bg-neutral-950/30 backdrop-blur-sm" />
                <div className="relative h-full flex items-center justify-center">
                  <div className="text-center">
                    <h4 className="text-2xl font-medium mb-2">Backdrop Blur</h4>
                    <p className="text-neutral-100/70">Content visible through the blur</p>
                  </div>
                </div>
              </div>
              <ShowCode code={`<div className="relative">
    ...
    <Layout>
              ...
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded-md text-sm font-mono uppercase tracking-wider transition-colors ${
                  activeSection === section.id
                    ...
                    : 'text-neutral-100/50 hover:text-neutral-100/70 hover:bg-neutral-100/5'
                }`}
              >
                {section.label}
              </button>
      ...
      <div className="space-y-24 max-w-4xl mx-auto pb-24">
        <div>
          ...
          <p className="text-neutral-100/70 mb-12">
        ...
        {sections.map(section => (
          <section key={section.id} id={section.id} className="content-section scroll-mt-24">
            <div className="space-y-4 mb-8">
              ...
              <p className="text-neutral-100/70">{section.description}</p>
            </div>
        ...
        <section id="components" className="content-section scroll-mt-24">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-neutral-100/70">Essential indicators for system status and warnings.</p>
          </div>
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap gap-4">
                  ...
                  <div className="px-1.5 py-0.5 rounded-full text-[10px] font-mono uppercase tracking-wider border bg-neutral-500/20 text-neutral-300 border-neutral-500/30">
                    archived
                  </div>
