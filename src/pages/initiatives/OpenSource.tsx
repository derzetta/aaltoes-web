  ...
  >
    <div className="flex items-start justify-between mb-4">
      ...
      <span className={`text-sm font-mono px-2 py-1 rounded border ${
        status === "Coming Soon" 
          ? "text-zinc-400 bg-zinc-900/50 border-zinc-700/20" 
          : "text-emerald-400 bg-emerald-950/50 border-emerald-400/20"
      }`}>{status}</span>
    </div>
    <p className="text-zinc-400 leading-relaxed mb-6 flex-grow">{description}</p>
    <div className="flex flex-wrap gap-2">
      {tech.map((t, i) => (
        <span key={i} className="text-xs font-mono text-zinc-500 px-2 py-1 bg-zinc-900 rounded-full">{t}</span>
      ))}
    </div>
  </motion.div>
)
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-7xl mx-auto px-6 pb-16">
        ...
        >
          ...
          <div className="absolute w-full py-2 md:py-4 flex space-x-4 md:space-x-6 animate-scroll-left">
            {[
              ...
              >
                ...
                <p className="text-xs md:text-sm text-zinc-400">{project.desc}</p>
              </div>
            ))}
          </div>

          {/* Row 2 - Moving Right - Community & Infrastructure */}
          <div className="absolute top-[92px] md:top-[120px] w-full py-2 md:py-4 flex space-x-4 md:space-x-6 animate-scroll-right">
            {[
          ...
          <div className="absolute top-[184px] md:top-[240px] w-full py-2 md:py-4 flex space-x-4 md:space-x-6 animate-scroll-left">
            {[
        ...
        <div className="space-y-24 mt-16">
          ...
          <section className="space-y-8">
            <div className="text-center space-y-4">
              <h2 className="text-3xl font-medium text-zinc-100">Project Lifecycle</h2>
          ...
          <section className="space-y-8">
            <div className="text-center space-y-4">
              <h2 className="text-3xl font-medium text-zinc-100">Community Infrastructure</h2>
              <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
          ...
          <section className="flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2 space-y-8">
              <h2 className="text-3xl font-medium text-zinc-100">Finnish Open Source Heritage</h2>
            ...
            <div className="w-full md:w-1/2">
              <div className="relative aspect-square rounded-2xl bg-zinc-900/30 backdrop-blur-sm border border-zinc-800/50 p-8 flex items-center justify-center">
                ...
                <div className="relative space-y-8 text-center max-w-sm">
                  <h3 className="text-2xl font-medium text-zinc-100">Join the Movement</h3>
                  <p className="text-zinc-400">
                    Be part of Finland's growing open source community. Contribute to projects, learn from peers, and build the future of technology.
                  </p>
                  <div>
                    <a 
                    ...
                    >
                      <span className="relative z-10 uppercase">Visit GitHub</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <section className="space-y-16">
            <div className="text-center space-y-4">
              <h2 className="text-3xl font-medium text-zinc-100">Foundation Projects</h2>
              <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <ProjectCard
                ...
                description="An AI-powered assistant designed to help students and entrepreneurs navigate the Finnish startup ecosystem, built with advanced language models and community knowledge."
          ...
          <section className="space-y-16">
            <div className="text-center space-y-4">
              <h2 className="text-3xl font-medium text-zinc-100">Join Our Community</h2>
              <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
          ...
          <section className="pt-16">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-xl font-medium text-zinc-100">Doni Pracner</h3>
                  <p className="text-zinc-400 font-normal">Open Source Lead</p>
                </div>
              </div>
