      ...
      <div className="max-w-5xl w-full border border-zinc-800 rounded-lg overflow-hidden relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8 md:p-12 bg-black">
            <h1 className="text-3xl md:text-5xl font-mono font-bold text-white mb-4 tracking-tight leading-tight">
              ZERO<br />
              BULLSHIT<br />
              HACKATHON
            </h1>
          ...
          {/* Right Column - Divided into two boxes */}
          <div className="bg-black border-t md:border-t-0 md:border-l border-zinc-800">
            ...
            <div className="p-8 md:p-10 border-b border-zinc-800">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-mono text-white px-2 py-0.5 bg-zinc-800 rounded border border-zinc-700 uppercase">Advanced</span>
              </div>
              ...
              <div className="mt-6">
                <div className="text-2xl font-mono text-white font-bold">$10,000</div>
                <div className="text-zinc-400 font-mono text-sm">Cash Prize</div>
              </div>
            </div>
            ...
            <div className="p-8 md:p-10">
              ...
              <div className="mt-8 pt-6 border-t border-zinc-800">
                <p className="text-zinc-400 font-mono text-sm mb-3">In partnership with</p>
                <div className="flex flex-wrap items-center gap-6">
                  <div className="text-zinc-300 font-mono text-sm">SmartBI</div>
                  <div className="text-zinc-300 font-mono text-sm">Microsoft</div>
                  <div className="text-zinc-300 font-mono text-sm">Ultrahack</div>
                </div>
              </div>
            </div>
          </div>
