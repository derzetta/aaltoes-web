          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center">
              <a 
                ...
                className="group relative px-4 sm:px-6 py-2.5 sm:py-3 bg-black/30 backdrop-blur-xs text-white/70 rounded-lg border border-white/10 font-mono text-sm tracking-widest transition-all hover:text-white hover:bg-black/40 hover:border-white/20 inline-flex items-center justify-center"
              >
